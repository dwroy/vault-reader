...
- Product: native read-only vault reader; iOS first, Android second. Current scope is M1a. Follow `docs/ARCHITECTURE.md` and record acceptance limits honestly in `docs/ACCEPTANCE.md`.
